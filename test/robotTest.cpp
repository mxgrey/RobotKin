...
//        parseTest.linkage("Body_RSP").gravityJointTorques(torques, false);
...
//    cout << "RSP Torque: " << parseTest.joint("RSP").gravityTorque() << endl;
...
//    VectorXd jointVals;
//    jointVals.resize(parseTest.linkage("RightArm").nJoints());
//    jointVals.setZero();
